...
namespace MythosOfMoonLight.Projectiles.PurpurineSaber
{
    public class PurpurineSaber : ModProjectile
    {
        ...
        public override void AI()
        {
            if (projectile.ai[0] == 0)
            {
                ...
                {
                    Projectile.NewProjectile(projectile.Center + new Vector2(21, 0).RotatedBy(projectile.rotation), new Vector2(8, 0).RotatedBy(projectile.rotation), ModContent.ProjectileType<PurpurineSaber>(), projectile.damage, projectile.knockBack, projectile.owner, projectile.frame);
                }
            }
            else
            {
