    ...
    public class FallingStarTiny : ModProjectile
    {
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            if (Projectile.ai[0] == 0)
            {
                ...
                Main.spriteBatch.Draw(tex, Projectile.Center + new Vector2(3).RotatedBy(Projectile.rotation) - Main.screenPosition, null, Color.LightBlue * 0.5f * alpha, Projectile.velocity.ToRotation() + MathHelper.PiOver2, new Vector2(tex.Width / 2, tex.Height / 4), 1f * 0.3f, SpriteEffects.None, 0);
                Main.spriteBatch.Draw(tex, Projectile.Center + new Vector2(3).RotatedBy(-Projectile.rotation) - Main.screenPosition, null, Color.LightBlue * 0.5f * alpha, Projectile.velocity.ToRotation() + MathHelper.PiOver2, new Vector2(tex.Width / 2, tex.Height / 4), 1f * 0.3f, SpriteEffects.None, 0);
